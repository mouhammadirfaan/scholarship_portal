# Generated by Django 4.1 on 2022-12-11 17:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('scholarship', '0049_remove_applyscholarship_addscholarship_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disability', models.CharField(blank=True, max_length=200)),
                ('institution', models.CharField(blank=True, max_length=200)),
                ('registration', models.CharField(blank=True, max_length=200)),
                ('start', models.DateField()),
                ('end', models.DateField()),
                ('gname', models.CharField(blank=True, max_length=100)),
                ('gcnic', models.CharField(blank=True, max_length=100)),
                ('itype', models.CharField(blank=True, max_length=200)),
